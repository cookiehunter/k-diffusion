...
def sample_euler(model, x, sigmas, extra_args=None, callback=None, disable=None, s_churn=0., s_tmin=0., s_tmax=float('inf'), s_noise=1.):
    ...
    for i in trange(len(sigmas) - 1, disable=disable):
        ...
        denoised = model(x, sigma_hat * s_in, i, **extra_args)
...
def sample_heun(model, x, sigmas, extra_args=None, callback=None, disable=None, s_churn=0., s_tmin=0., s_tmax=float('inf'), s_noise=1.):
    ...
    for i in trange(len(sigmas) - 1, disable=disable):
        ...
        if sigmas[i + 1] == 0:
            ...
            # Heun's method
            x_2 = x + d * dt
            denoised_2 = model(x_2, sigmas[i + 1] * s_in, i, **extra_args)
...
def sample_dpm_2(model, x, sigmas, extra_args=None, callback=None, disable=None, s_churn=0., s_tmin=0., s_tmax=float('inf'), s_noise=1.):
    ...
    for i in trange(len(sigmas) - 1, disable=disable):
        ...
        if sigmas[i + 1] == 0:
            ...
            x_2 = x + d * dt_1
            denoised_2 = model(x_2, sigma_mid * s_in, i, **extra_args)
...
def sample_dpmpp_2s_ancestral(model, x, sigmas, extra_args=None, callback=None, disable=None, eta=1., s_noise=1.):
    ...
    for i in trange(len(sigmas) - 1, disable=disable):
        ...
        if sigma_down == 0:
            ...
            denoised_2 = model(x_2, sigma_fn(s) * s_in, i, **extra_args)
